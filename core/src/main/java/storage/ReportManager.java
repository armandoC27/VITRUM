...
public class ReportManager {
    ...
    public static void saveReport(TestProjectAnalysis proj) {
        ...
        if (flagCLI) {
            ...
            //se viene chiamato dal plugin ( e non dal modulo controller) allora viene aggiunto l'header iniziale
            output += proj.getName() + ";" + proj.getLoc() + ";" + proj.getNom() + ";" + proj.getRfc() + ";" + proj.getWmc() + ";" + proj.getTestClassesNumber() + "\n";
        }
